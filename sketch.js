...
//Aim: to create Tower Siege Game using Constrained Bodies and make the Boxes disappear and adding Score
//Project demonstrates throwing rock(hexagon) at a group of stacked objects and crash them on ground and they disappear
//adding score to project using Visibility property
...
function draw(){
    ...
    fill("black")
    textFont('Georgia');
    text("Tower Siege - 3",400,60)
    text("1) Drag the Hexagonal stone",20,140);
    text("2) Release(launch) it towards blocks",20,170);
    text("3) Press SPACE to try again",20,200)
    text("4) ONE block destroyed gives you 20 points",20,230)
